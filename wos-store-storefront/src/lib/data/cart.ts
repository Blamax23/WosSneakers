...
const CART_FIELDS =
  "*items,*region,*items.product,*items.variant,*items.thumbnail,*items.metadata,+items.total,*promotions,*payment_collection,*payment_collection.payment_sessions,*shipping_methods,*shipping_methods.shipping_option,*billing_address,*shipping_address"
